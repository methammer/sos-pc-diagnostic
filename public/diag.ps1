...
Write-Host ""; Write-Host "  Collecte des informations systeme..." -ForegroundColor White; Write-Host ""
...
Write-Host ""; Write-Host "  Envoi des donnees vers SOS-PC..." -ForegroundColor White
